...
$$w_1 = b^nbab^nbaba$$
$$w_2 = b^nbab^nb^nbab^nba$$

Рассмотрим префикс $x = b^nbab^nb$.
При накачке $b^n$ слово $w_1$ выходит из языка $\to L \notin DCFL$.
т.к достаточно длинные $b^n$  может появиться только из T->bTb.
Также это является проверкой на беспрефиксность.

![Граф проверки](graphviz%20(6)%201.svg)
...
![Диаграмма 2](graphviz%20(7)%201.svg)
![Диаграмма 3](graphviz%20(8).svg)
![Диаграмма 4](Pasted%20image%2020260116200637.png)
![Диаграмма 5](Pasted%20image%2020260116200651.png)
...
![LL1 Диаграмма](svgviewer-output%20(2).svg)
![LL1 Доп](Pasted%20image%2020260116210303.png)
